 ...
 * NOTE: this is an update multiboot.h where uint64_t is replaced with two uint32_t
 *
 */
...
typedef struct multiboot_info multiboot_info_t; // UPDATED 
...
/** UPDATED multiboot memory map entry */
